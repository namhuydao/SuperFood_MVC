        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div style="width: 40%; margin: auto">
                    <form action="/superFood/admin/widget/update/{{$widget->id}}" method="POST" enctype="multipart/form-data">
                        <div class="form-group position-relative text-center">
                            <img class="imagesForm" width="100" height="100" src="/superFood/backend/assets/images/{{ $widget->image }}"/>
