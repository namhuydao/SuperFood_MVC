                ...
                <div style="width: 40%; margin: auto">
                    <form action="/superFood/admin/product/update/{{$product->id}}" method="POST"
                        ...
                        <div class="form-group position-relative text-center">
                            <img class="imagesForm" width="100" height="100" src="/superFood/backend/assets/images/{{$product->avatar}}"/>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group position-relative text-center">
                                <img class="imagesForm" width="100" height="100" src="/superFood/backend/assets/images/product/default.png"/>
