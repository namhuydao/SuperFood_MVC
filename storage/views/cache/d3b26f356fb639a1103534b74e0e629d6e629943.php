                    ...
                    <div class="profile__content row">
                        <div class="col-md-4">
                            <div class="profile__left">
                                ...
                                <a href="/superFood/admin/userProfile/edit/<?php echo e($user->id); ?>" id="infoBtn" class="btn btn-light" style="width: 100%;display: flex">
                        ...
                        <div class="col-md-8">
                            <div class="profile__right">
                                <div class="profile__pass active">
                                    ...
                                    <form action="/superFood/admin/userProfile/passUpdate/<?php echo e($user->id); ?>" method="POST">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SuperFood\resources\views/admin/password/change.blade.php ENDPATH**/ ?>