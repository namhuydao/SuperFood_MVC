                    ...
                    <div class="profile__content row">
                        <div class="col-md-4">
                            <div class="profile__left">
                                ...
                                <a href="/superFood/admin/userProfile/passEdit/<?php echo e($user->id); ?>" id="resetBtn"
                        ...
                        <div class="col-md-8">
                            <div class="profile__right">
                                <div class="profile__info active">
                                    ...
                                    <form action="/superFood/admin/userProfile/update/<?php echo e($user->id); ?>" method="POST"
                                        ...
                                        <div class="avatar form-group">
                                            ...
                                            <div class="avatar_img" style="width: 60%">
                                                ...
                                                <a href="/superFood/admin/userProfile/deleteImage/<?php echo e($user->id); ?>"
